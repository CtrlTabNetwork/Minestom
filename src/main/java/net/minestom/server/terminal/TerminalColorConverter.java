...
final class TerminalColorConverter {
	private static final boolean SUPPORT_HEX_COLOR = Boolean.parseBoolean(
			System.getProperty("minestom.terminal.support-hex-color", "true"));
	private static final boolean SUPPORT_COLOR = Boolean.parseBoolean(
			System.getProperty("minestom.terminal.support-color", "true"));
